...
for employee in data['employees']:
    employee_loc = data['employees'][employee]['location']
    employee_name = data['employees'][employee]['name']
    for office in data['location']['offices']:
        if employee_loc == office['id']:
            print(f"{employee_name}; {office['address']}")
